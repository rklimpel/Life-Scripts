...
# ==========================================
def generate_comparison_charts(df: pd.DataFrame, img_dir: str):
    ...
    ax.set_title(f"Cumulative Training Hours Over the Year", fontsize=16, weight='bold')
...
# MARKDOWN GENERATOR
# ==========================================
def generate_comparison_markdown(df: pd.DataFrame, output_md: str):
...
def main():
    ...
    generate_comparison_charts(df, img_dir)
    generate_comparison_markdown(df, output_md)
